...
export function filterPedidos<T extends PedidoForSearch>(pedidos: T[], searchQuery: string, statusFilter: "todos" | PedidoStatus) {
...
export function buildQueryHref(
  nextValues: { query?: string; status?: "todos" | PedidoStatus; page?: number },
  currentQuery: string,
